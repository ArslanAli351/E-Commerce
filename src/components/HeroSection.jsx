...
export default function HeroSection() {
  return (
    <>
      <div>
        <div className=" mt-4 border-t-0	border-l-0	 border-b-0	ml-20 w-[217px] h-[344px] font_1 border-2 flex justify-evenly flex-col qs:mt-[380px] qs:w-[390px] qs:ml-0 qs:border-2 qs:border-red-600	qs:flex-row qs:absolute qs:h-32 qs:flex-wrap  qs:justify-between">
          ...
          <p className="hover:text-primary qs:mt-4 ">Electronics</p>
